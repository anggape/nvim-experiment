...
vim.api.nvim_create_autocmd("CursorHold", {
	...
	callback = function()
		...
		local controls = string.format("a=T,i=%d,f=32,s=%d,v=%d,c=30,r=10,q=2", image_id, image.width, image.height)
			...
			temp_move_cursor(row, col, function()
				for i = 1, #encoded, chunk_size do
					...
					if chunk ~= "" then
						...
						local control = ((i == 1) and (controls .. ",") or "") .. "m=" .. (has_more and 1 or 0)
